...
export const quotedTemplateContentSchema = z.object({
...
export const forExpressionSchema = z.object({
  type: z.literal(NodeTypes.ForExpression),
  kind: z.union([z.literal(ForKinds.Tuple), z.literal(ForKinds.Object)]),
  intro: z.object({
...
export const attrSplatOperatorSchema = z.object({
  ...
  attrs: z.array(getAttributeOperatorSchema),
  target: expressionSchema,
...
export const fullSplatOperatorSchema = z.object({
  ...
  ops: z.array(z.union([getAttributeOperatorSchema, indexOperatorSchema])),
  target: expressionSchema,
