...
export type StartRuleNames = "ConfigFile";
export interface ParseOptions<T extends StartRuleNames = "ConfigFile"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"ConfigFile">>(
  input: string,
  options?: Options,
): any;
